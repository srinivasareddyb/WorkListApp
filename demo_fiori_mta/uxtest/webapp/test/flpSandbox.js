		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#uxtestcomuxtest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxtestcomuxtest-display": {
								"semanticObject": "uxtestcomuxtest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uxtest.com.uxtest",
									"url": sap.ui.require.toUrl("uxtest/com/uxtest")
								}
							}
						}
					}
