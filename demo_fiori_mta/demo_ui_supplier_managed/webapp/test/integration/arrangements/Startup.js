sap.ui.define([
	"sap/ui/test/Opa5",
	"supplier/demo/com/demouisuppliermanaged/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("supplier.demo.com.demouisuppliermanaged.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "supplier.demo.com.demouisuppliermanaged",
					async: true
				},
				hash: oOptions.hash,
