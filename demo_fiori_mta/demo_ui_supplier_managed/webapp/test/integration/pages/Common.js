sap.ui.define([
	...
	return Opa5.extend("supplier.demo.com.demouisuppliermanaged.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["supplier/demo/com/demouisuppliermanaged/localService/mockserver"], function (mockserver) {
