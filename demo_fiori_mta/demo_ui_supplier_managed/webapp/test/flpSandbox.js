		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#supplierdemocomdemouisuppliermanaged-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"supplierdemocomdemouisuppliermanaged-display": {
								"semanticObject": "supplierdemocomdemouisuppliermanaged",
								"action": "display",
								"description": "Supplier Detail Information",
								"title": "Supplier Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=supplier.demo.com.demouisuppliermanaged",
									"url": sap.ui.require.toUrl("supplier/demo/com/demouisuppliermanaged")
								}
							}
						}
					}
