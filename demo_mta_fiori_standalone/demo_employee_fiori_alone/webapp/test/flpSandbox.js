		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#demoemployeefiorialone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"demoemployeefiorialone-display": {
								"semanticObject": "demoemployeefiorialone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=demoemployeefiorialone",
									"url": sap.ui.require.toUrl("demoemployeefiorialone")
								}
							}
						}
					}
